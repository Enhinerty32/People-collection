    ...
    final myUserVoid =
      ...
      ListPerson(
          generalInformation: GeneralInformation(
              ...
              bloodType: '',
              birthDate: '',
              locations: [Location(namePlace: '',place: Place(lat: 0.0, lng: 0.0))]),
          interests: Interests(
              mysticalInterests: [''],
              hobbyAreas: [''],
              musicalPreferences: [''],
          ...
          diagnosedData: DiagnosedData(
              ...
              sleepPattern: SleepPattern(
                  wakeUp: DateTime(0),
                  sleepTime: DateTime(0),
                  sleepDuration: 0,
                  energyPeak: DateTime(0),
                  tirednessPeak: DateTime(0)),
              diagnosedConditions: [],
              diagnosis: '',
              menstrualCycle: MenstrualCycle(
                  start: DateTime(0), bloodDuration: 0, cycleLength: 0)))
    ]);
